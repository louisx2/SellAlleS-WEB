...
export function AppSkeleton({ message = 'Cargando plataforma...' }: { message?: string }) {
  return (
    <div className="flex min-h-screen">
      {/* Overlay with spinner */}
      <div className="absolute inset-0 z-50 flex flex-col items-center justify-center gap-3 bg-background/80">
